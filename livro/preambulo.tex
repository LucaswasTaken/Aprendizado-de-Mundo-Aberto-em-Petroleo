...
\hypersetup{
  ...
  pdfauthor = {Lucas Gouveia Omena Lopes; Thales Miranda de Almeida Vieira; Eduardo Toledo de Lima Junior; William Wagner Matos Lira; Pedro Esteves Aranha; Ricardo Emanuel Vaz Vargas},
  ...
  pdfinfo = {
    ISBN = {978-65-02-28836-8},
    DOI  = {10.5281/zenodo.22306796}
  }
}
...
\newenvironment{projetospesquisa}%
  {\section*{Projetos de pesquisa}\addcontentsline{toc}{section}{Projetos de pesquisa}%
   \begin{enumerate}[label=\textbf{\arabic*.},leftmargin=*,itemsep=0.4em]}%
  {\end{enumerate}}

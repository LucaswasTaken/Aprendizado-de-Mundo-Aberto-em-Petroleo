...
Temperatura de formação de hidrato pela correlação de Motiee, com
$x=\log_{10}(P/\mathrm{psia})$, saída em graus Fahrenheit e $\gamma$ a densidade
relativa do gás (\cref{cap:closedworld}):

\begin{equation}
T_{\text{hid}} = -238{,}24469 + 78{,}99667x - 5{,}352544x^2
+ 349{,}473877\gamma - 150{,}854675\gamma^2 - 27{,}604065x\gamma
\label{eq:for-motiee}
\end{equation}

Margem térmica percentual, com $T$ e $T_{\text{hid}}$ na mesma escala de temperatura:

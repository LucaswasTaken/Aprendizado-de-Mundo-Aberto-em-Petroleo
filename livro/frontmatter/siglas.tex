...
\begin{description}[leftmargin=3.6cm,style=nextline,font=\normalfont\bfseries,itemsep=0.15em]
\item[3W] Conjunto de dados público de eventos indesejáveis em poços (\ing{wells}) de
      petróleo, mantido pela Petrobras. O ``3'' refere-se às três procedências das
      instâncias: reais, simuladas e desenhadas à mão.

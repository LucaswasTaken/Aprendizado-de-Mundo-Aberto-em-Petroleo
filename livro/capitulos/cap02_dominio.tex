...
\begin{itemize}[leftmargin=*,itemsep=0.2em]
  ...
  \item explicar a função dos sensores PDG e TPT e justificar por que o subconjunto
        recorrente de quatro variáveis aparece na maior parte dos métodos deste livro;
...
\begin{figure}[htbp]
\centering
\includegraphics[width=0.42\textwidth]{esquema_poco_submarino.png}
...
interesse. Esse núcleo não é uma regra universal: o sistema dual acrescenta um quinto
sinal, e os experimentos dos \cref{cap:binarios,cap:closedworld} usam oito quando a
disponibilidade permite. A \cref{tab:dados-janelas} registra essas diferenças.
...
friccional e, quando relevante, da aceleração. Em uma geometria e um regime de escoamento
fixados, maior densidade tende a aumentar a componente hidrostática, enquanto menor vazão
tende a reduzir a friccional. Em escoamento multifásico, inclinação, holdup, sentido do
fluxo e posição efetiva dos sensores podem alterar essa leitura.

Um único par de sensores fornece, portanto, indícios combinados sobre propriedades
distintas do escoamento, sem identificá-las isoladamente. É por essa razão que o agente de linguagem do

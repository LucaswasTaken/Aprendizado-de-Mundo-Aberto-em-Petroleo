...
\begin{itemize}[leftmargin=*,itemsep=0.2em]
  \item descrever a estrutura e o mecanismo de treinamento de um perceptron de múltiplas
        camadas e explicar por que ele é inadequado a séries temporais longas;
  \item explicar o funcionamento das células LSTM e GRU e o problema do gradiente
        evanescente que elas resolvem;
  \item aplicar convoluções unidimensionais a sinais e calcular o campo receptivo de uma
        pilha convolucional;
  \item construir um autoencoder, interpretar seu espaço latente e usar o erro de
        reconstrução como escore de anomalia;
  ...
  \item enunciar o mecanismo de atenção e situar o Transformer no contexto deste livro.
\end{itemize}
\end{objetivos}

...
O 3W --- o nome vem de \ing{three W}: \ing{wells}, \ing{waves}, \ing{winds}, embora na
prática designe eventos indesejáveis reais em poços --- foi publicado pela Petrobras
...
\begin{destaque}[A ordem importa]
Padronizar antes de normalizar para $[0,1]$, como faz o \cref{cap:agente}, não é
redundante: o escore $z$ remove o nível e a escala específicos do poço, e a normalização
posterior acomoda a saída ao intervalo esperado pelo modelo. Inverter a ordem
reintroduziria a dependência do nível absoluto.
\end{destaque}

...
\begin{itemize}[leftmargin=*,itemsep=0.2em]
  ...
  \item construir um autoencoder LSTM para detecção de anomalias e definir seu limiar
        pela regra $\mu + 3\sigma$;
...
julgados anômalos nunca retornam ao conjunto de treinamento.}
...
O caso do poço 3 é o mais instrutivo, porque tem começo, meio e fim documentados.
...
se parecia com a normalidade daquele poço.

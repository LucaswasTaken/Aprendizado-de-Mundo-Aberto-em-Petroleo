...
\begin{itemize}[leftmargin=*,itemsep=0.2em]
  ...
  \item aplicar e comparar quatro famílias de escore de novidade: erro de reconstrução,
        máquina de vetores de suporte de uma classe, distância de Mahalanobis e rejeição
        por ensemble binário;
  \item aplicar os algoritmos K-means, MeanShift e DBSCAN, e escolher entre eles a partir
        das hipóteses que cada um faz;
  \item avaliar a qualidade de um agrupamento sem rótulos usando os índices de silhueta,
        Davies-Bouldin e Calinski-Harabasz;
  \item usar PCA, t-SNE e UMAP para inspeção visual, reconhecendo os limites de cada um.
\end{itemize}
\end{objetivos}
...
três descritores geométricos). O estimador atinge $98{,}3\,\%$ de acurácia com erro
médio de $1{,}12$ agrupamentos.
\end{destaque}

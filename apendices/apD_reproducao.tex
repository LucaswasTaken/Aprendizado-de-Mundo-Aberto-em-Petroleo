...
Este apêndice reúne as informações necessárias para reproduzir os experimentos
...
Cada uma dessas técnicas tende a melhorar o desempenho. Os resultados do
\cref{cap:resultados-agente} devem, portanto, ser lidos como piso, e não como teto.
\end{destaque}
...
\item[Intervalos de confiança.] Wilson a $95\,\%$ (\cref{eq:for-wilson}) em todas as
proporções reportadas.
...
Um sistema com desvio de $0{,}187$ entre poços não é implantável, ainda que sua média
seja aceitável, porque o operador não tem como saber em qual regime está.
\end{destaque}
